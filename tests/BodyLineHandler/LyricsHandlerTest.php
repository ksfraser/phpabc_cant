...
class LyricsHandlerTest extends TestCase {
	...
	public function testHandleSetsLyricsOnBar() {
		...
		$this->assertEquals('hello world', $context['voiceBars']['V1'][1]->lyrics);
	}
	...
	public function testHandleWithBarLinesInLyrics() {
		...
		$this->assertEquals('foo', $context['voiceBars']['V1'][1]->lyrics);
		$this->assertEquals('bar', $context['voiceBars']['V1'][2]->lyrics);
		$this->assertEquals('baz', $context['voiceBars']['V1'][3]->lyrics);
