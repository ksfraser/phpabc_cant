...
$abc['{agag}']['cannt'] = 'dili';
//Doublings
$abc["{gGd}G"]['cannt'] = 'hemtem';
$abc["{gAd}A"]['cannt'] = 'henten';
$abc["{gBd}B"]['cannt'] = 'hoto';
$abc["{gcd}c"]['cannt'] = 'hoto';
$abc["{gde}d"]['cannt'] = 'hata';
$abc["{gef}e"]['cannt'] = 'hete';	//chehe
$abc["{gfg}f"]['cannt'] = 'chete';  	//hehe
$abc["{afg}f"]['cannt'] = 'chete'; 
//Thumb Dbl
$abc["{aGd}G"]['cannt'] = 'himtin';
$abc["{aAd}A"]['cannt'] = 'hintin';
$abc["{aBd}B"]['cannt'] = 'hoto';
$abc["{acd}c"]['cannt'] = 'hoto';
$abc["{ade}d"]['cannt'] = 'hota';
$abc["{aef}e"]['cannt'] = 'dre';
$abc["{afg}f"]['cannt'] = 'dare';
//Half  Dbl
$abc["{Gd}G"]['cannt'] = 'emten';
$abc["{Ad}A"]['cannt'] = 'intin';
$abc["{Bd}B"]['cannt'] = 'oto';
$abc["{cd}c"]['cannt'] = 'oto';
$abc["{de}d"]['cannt'] = 'ota';
$abc["{ef}e"]['cannt'] = 'ete';
//$abc["{fg}f"]['cannt'] = 'dare';	//throw
$abc["{fg}f"]['cannt'] = 'vete';	//half doubling
//Throws
